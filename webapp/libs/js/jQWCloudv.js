var LB = 1, //Left Bottom
	...
	WordObjType = 'span',
	DIV = 'div',
	Word_Default_font_Family = 'Montserrat',
	distance_Counter = 1,
	word_counter = 1;
...
WordCloud.prototype = {
	...
	_showSpaceDiv: function (type, w, h, x, y) {
		...
		$(div).css("left", x + xMul * w).css("top", y + yMul * h).css("width", w).css("height", h).css("border", "1px " + this.options.spaceDIVColor +
			" solid").css("position", "absolute").css("display", "block");
